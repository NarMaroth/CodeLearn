...
print("salto promedio de " + nombre + ":" + str(promedio)) #concatenaciion con conversion de variables

print("salto promedio de ",nombre,":", promedio) #concatenaciion sin conversion de variables